...
const ProductCreate = () => {
  ...
  const onFinish = (values) => {
    ...
    console.log(payload);
    axios.post(`${URL_API}/Product/create-product`, payload).then((res) => {});
  };
                  ...
                  {fields.map(({ key, name }) => {
                    return (
                      <div>
                        ...
                        <div key={key} onClick={() => setIndexSelect(key)}>
                          ...
                          <Upload
                            ...
                            fileList={
                              indexSelect === key ? Images[key]:fileList 
                            }
